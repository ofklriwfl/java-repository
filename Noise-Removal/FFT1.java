...
//https://introcs.cs.princeton.edu/java/97data/FFT.java from Robert Sedgewick and Kevin Wayne
/******************************************************************************
...
public class FFT1 {
    ...
    public static Complex[] fft(Complex[] x) {
        ...
        /*for (int index = 0; index < oddFFT.length; index++) {
        	System.out.println(oddFFT[index].re());
        }
        */
        ...
        double anglePart = -2 * Math.PI / n;
        for (int k = 0; k < n/2; k++) {
        //for (int k = 0; k < n; k++) {
            double kth = -2 * k * Math.PI / n;
            Complex wk = new Complex(Math.cos(kth), Math.sin(kth));
        	//Complex wk = new Complex(Math.cos(anglePart * k), Math.sin(anglePart * k));
            y[k]       = evenFFT[k].plus (wk.times(oddFFT[k]));
            /*System.out.println(y[k].re());
            System.out.println(evenFFT[k].re());
            System.out.println(wk.re());
            System.out.println(oddFFT[k]);
            */
        	//y[k] = evenFFT[k].plus(new Complex((wk.re() * oddFFT[k].re()) - (wk.im() * oddFFT[k].im()), (wk.re() * oddFFT[k].im()) + (wk.im() * oddFFT[k].re())));
            //y[k + n/2] = evenFFT[k].minus(new Complex((wk.re() * oddFFT[k].re()) - (wk.im() * oddFFT[k].im()), (wk.re() * oddFFT[k].im()) + (wk.im() * oddFFT[k].re())));
